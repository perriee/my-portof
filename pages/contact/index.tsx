...
const Contact = () => {
    return (
        ...
        ><div className="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
            ...
            <h2 className="text-5xl text-sky-300 font-semibold">Get In Touch</h2>
            ...
            <a href="mailto:ismaelmiah@devismael.com">
                <p className="click-button w-40 h-14 border rounded uppercase border border-sky-300 font-semibold mt-6 text-sky-300 tracking-wider rounded-md flex items-center justify-center">
                    Say Hello
                </p>
            </a>
        </div>
